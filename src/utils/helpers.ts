 ...
 * */
export function replaceOriginal(original: IAnyObject, replaceFn: string, callbackOriginal: Callback, isForced = false): void {
...
export function on<T extends EventTarget, K extends keyof EventMap<T>>(
    ...
    type: keyof GlobalEventHandlersEventMap | keyof XMLHttpRequestEventTargetEventMap | keyof WindowEventMap | keyof DocumentEventMap,
